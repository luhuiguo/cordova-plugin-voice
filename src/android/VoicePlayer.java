...
public class VoicePlayer implements OnCompletionListener, OnPreparedListener, OnErrorListener {
    ...
    // VoicePlayer message ids
    private static int VOICE_STATE = 1;
    private static int VOICE_DURATION = 2;
    private static int VOICE_POSITION = 3;
...
//    private static int VOICE_ERR_NONE_SUPPORTED = 4;
    ...
    /**
     * Destroy player and stop voice playing or recording.
     */
    public void destroy() {
    ...
    public float getDuration(String file) {
        ...
        // If voice file already loaded and started, then return duration
        if (this.player != null) {
